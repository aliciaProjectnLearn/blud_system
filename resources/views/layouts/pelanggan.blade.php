                ...
                <nav class="navbar navbar-expand navbar-light navbar-pelanggan mb-4 sticky-top">
                    <div class="container py-2">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="btn btn-outline-primary btn-kembali px-3 px-sm-4 shadow-sm d-flex align-items-center" href="{{ route('user.gateway') }}">
                                    <i class="fas fa-arrow-left"></i> 
                                    <span class="d-none d-sm-inline ml-2">Dashboard Utama</span>
                                </a>
                            </li>
                        </ul>
                    </div>
