...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="font-weight-bold mb-0 text-gray-800">
            <i class="fas fa-history mr-2 text-primary"></i> Audit Log Kantin
        </h4>
        <small class="text-muted">
            Rekaman otomatis seluruh aktivitas sistem kantin
        </small>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center pr-4">
                                ...
                                <a href="{{ route('admin.kantin.audit.show', $log->id) }}"
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                Belum ada aktivitas yang tercatat untuk sistem kantin.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
