<?php $__env->startSection('title', 'Form Sewa Kantin Baru'); ?>
...
<div class="container-fluid pb-5">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('user.kantin.dashboard')); ?>" class="btn btn-sm btn-secondary shadow-sm">
    ...
    <form id="form-booking" action="<?php echo e(route('user.kantin.booking.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="form-group mb-0">
                                ...
                                <select id="select-unit" name="ruko_id" class="form-control <?php $__errorArgs = ['ruko_id'];
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($unit->id); ?>"
                                            <?php echo e(old('ruko_id') == $unit->id ? 'selected' : ''); ?>>
                                            <?php echo e($unit->kode_unit); ?><?php echo e($unit->no_unit ? ' - ' . $unit->no_unit : ''); ?>

                                            &nbsp;|&nbsp; Rp <?php echo e(number_format($unit->harga, 0, ',', '.')); ?>/thn
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['ruko_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div class="card-body">
                        ...
                        <?php for($i = 0; $i < 4; $i++): ?>
                            <div class="skeleton" style="height:16px; margin-bottom:8px; border-radius:4px;
                                 ...
                                 width:<?php echo e([80, 60, 70, 50][$i]); ?>%;"></div>
                        <?php endfor; ?>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('tgl_mulai', date('Y-m-d'))); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="metode-tunai" name="metode_pembayaran" value="tunai"
                                       class="custom-control-input <?php $__errorArgs = ['metode_pembayaran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       <?php echo e(old('metode_pembayaran', 'tunai') === 'tunai' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                       <?php echo e(old('metode_pembayaran') === 'qris' ? 'checked' : ''); ?>>
...
$(function () {
    ...
    const BASE_DETAIL_URL = '<?php echo e(url("user/kantin/unit")); ?>';
    ...
    <?php if(old('ruko_id')): ?>
        $('#select-unit').val('<?php echo e(old("ruko_id")); ?>').trigger('change');
    <?php endif; ?>

    <?php if(old('metode_pembayaran') === 'qris'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/kantin/booking-form.blade.php ENDPATH**/ ?>