<?php $__env->startSection('title', 'Detail Booking AC'); ?>
        ...
        <div class="col-lg-10">
            ...
            <div class="status-hero animate__animated animate__fadeInDown">
                <div>
                    ...
                    <h2 class="font-weight-bold mb-0">Booking #<?php echo e(str_pad($booking->id, 4, '0', STR_PAD_LEFT)); ?></h2>
                    <p class="mb-0 mt-2 text-white-50"><i class="far fa-calendar-alt mr-2"></i> <?php echo e(\Carbon\Carbon::parse($booking->tgl_kunjungan)->translatedFormat('l, d F Y')); ?></p>
                </div>
                <div class="text-right">
                    ...
                    ?>
                    <span class="badge <?php echo e($badgeClass); ?> status-badge text-uppercase"><i class="fas <?php echo e($iconClass); ?> mr-2"></i><?php echo e($booking->status); ?></span>
                </div>
            </div>
            ...
            <div class="modern-card animate__animated animate__fadeInUp" style="position: relative; z-index: 2;">
                    ...
                    <div class="col-md-6">
                        <div class="info-group">
                            ...
                            <div class="info-content">
                                ...
                                <p><?php echo e($booking->nama_pelanggan); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-content">
                                ...
                                <p class="text-break"><?php echo e($booking->alamat); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="info-group" style="border-left-color: #1cc88a;">
                            ...
                            <div class="info-content">
                                ...
                                <p><?php echo e($booking->layanan->nama ?? '-'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-group" style="border-left-color: #1cc88a;">
                            ...
                            <div class="info-content">
                                ...
                                <p><?php echo e($booking->merek_ac ?? 'Tidak disebutkan'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-group" style="border-left-color: #1cc88a;">
                            ...
                            <div class="info-content">
                                ...
                                <p class="text-break"><?php echo e($booking->detail_keluhan ?? 'Tidak ada keluhan khusus'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php if($booking->detailServis->count() > 0): ?>
                    <div class="table-responsive table-modern">
                        <table class="table table-hover mb-0 border-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $booking->detailServis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-light rounded p-2 mr-3 text-secondary"><i class="fas fa-cog"></i></div>
                                            <div>
                                                <h6 class="mb-0 font-weight-bold text-dark"><?php echo e($ds->item); ?></h6>
                                                <?php if($ds->catatan): ?> <small class="text-muted"><?php echo e($ds->catatan); ?></small> <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center font-weight-bold"><?php echo e($ds->quantity); ?></td>
                                    <td class="text-right">Rp <?php echo e(number_format($ds->harga, 0, ',', '.')); ?></td>
                                    <td class="text-right font-weight-bold text-primary">Rp <?php echo e(number_format($ds->subtotal, 0, ',', '.')); ?></td>
                                </tr>
                            ...
                            <tfoot class="bg-light">
                                <tr>
                                    ...
                                    <th class="text-right py-3 text-success" style="font-size: 1.2rem; font-weight: 900;">Rp <?php echo e(number_format($booking->pembayaran->total_harga, 0, ',', '.')); ?></th>
                                </tr>
                            </tfoot>
                            <?php endif; ?>
                        </table>
                ...
                <?php if($booking->foto_hasil): ?>
                <div class="mt-5 mb-4 border-bottom pb-2">
                    <h5 class="font-weight-bold text-gray-800"><i class="fas fa-camera mr-2 text-primary"></i> Foto Dokumentasi</h5>
                </div>
                <div class="text-center">
                    <img src="<?php echo e(asset('storage/' . $booking->foto_hasil)); ?>" class="img-fluid rounded-lg shadow-sm" alt="Dokumentasi Pekerjaan" style="max-height: 400px; object-fit: cover; border: 4px solid #fff;">
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mt-5 mb-4 animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                ...
                <p class="text-muted small">Pekerjaan yang pernah kami lakukan untuk nomor <?php echo e($booking->no_hp); ?></p>
                    ...
                    <div class="col-md-6">
                        <div class="history-item bg-white p-3 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1 font-weight-bold text-dark"><?php echo e($item->layanan->nama ?? 'Layanan AC'); ?></h6>
                                    <small class="text-muted"><i class="far fa-calendar-alt mr-1"></i> <?php echo e(\Carbon\Carbon::parse($item->tgl_kunjungan)->translatedFormat('d M Y')); ?></small>
                                </div>
                            </div>
                            <div>
                                <span class="badge <?php echo e($item->status == 'selesai' ? 'badge-success' : ($item->status == 'proses' ? 'badge-info' : 'badge-warning')); ?> p-2 shadow-sm text-uppercase" style="border-radius: 8px;">
...
<?php echo $__env->make('layouts.publik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/ac/detail.blade.php ENDPATH**/ ?>