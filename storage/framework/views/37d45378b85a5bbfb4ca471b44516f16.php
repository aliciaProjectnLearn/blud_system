<?php $__env->startSection('title', 'Booking Lapangan Futsal'); ?>
...
<div class="container-fluid" x-data="bookingForm()" x-init="init()">
    ...
    <div class="alert alert-success border-left-success shadow-sm mb-4" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div>
                <strong>Membership Aktif</strong> — <?php echo e($membership->paket->nama_paket ?? 'Paket Membership'); ?><br>
                <small>Sisa kuota: <strong><?php echo e($membership->sisa_kuota); ?></strong> jam dari
                    <strong><?php echo e($membership->total_kuota); ?></strong> jam total</small>
            </div>
        </div>
    </div>
    <?php else: ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('user.futsal.booking.store')); ?>" method="POST" @submit.prevent="submitForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control <?php $__errorArgs = ['lapangan_id'];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="<?php echo e($lap->id); ?>" <?php echo e(old('lapangan_id') == $lap->id ? 'selected' : ''); ?>>
                                    <?php echo e($lap->nama); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group" x-show="form.type === 'regular'" :required="form.type === 'regular' && (slots.length > 0 || slotLoading)" x-cloak>
                            ...
                            <?php $__errorArgs = ['jam_mulai_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="text-danger small mt-1"><i class="fas fa-exclamation-circle"></i> <?php echo e($message); ?></div>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group" x-show="form.type === 'regular' && form.jam_mulai_id" x-cloak>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select class="form-control <?php $__errorArgs = ['durasi_main'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="card-body">
                    ...
                    <div class="summary-item" x-show="form.jenis_pembayaran === 'membership'" x-cloak>
                        ...
                        <span class="font-weight-bold text-info"
                              x-text="(<?php echo e($membership->sisa_kuota); ?> - parseInt(form.durasi_main)) + ' Jam'">
                        </span>
                    </div>
                    <?php endif; ?>
...
function bookingForm() {
    return {
        ...
        membershipKuota: <?php echo e($membership ? $membership->sisa_kuota : 0); ?>,
        hasMembership: <?php echo e($membership ? 'true' : 'false'); ?>,
        eventPesan: '',

        form: {
            type: '<?php echo e(old('type', 'regular')); ?>',
            lapangan_id: '<?php echo e(old('lapangan_id', '')); ?>',
            tanggal: '<?php echo e(old('tanggal', '')); ?>',
            jam_mulai_id: '<?php echo e(old('jam_mulai_id', '')); ?>',
            durasi_main: '<?php echo e(old('durasi_main', 1)); ?>',
            jenis_pembayaran: '<?php echo e(old('jenis_pembayaran', 'reguler')); ?>',
            start_datetime: '<?php echo e(old('start_datetime', '')); ?>',
            end_datetime: '<?php echo e(old('end_datetime', '')); ?>',
        },
        ...
        async fetchSlots() {
            ...
            this.eventPesan = '';
            try {
                const response = await axios.get('<?php echo e(route('user.futsal.booking.check')); ?>', {
                    params: {
                ...
                if (response.data.event) {
                    ...
                    const oldId = '<?php echo e(old('jam_mulai_id', '')); ?>';
                    if (oldId) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/futsal/booking.blade.php ENDPATH**/ ?>