<?php $__env->startSection('title', 'Detail Pekerjaan Servis'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Detail Pekerjaan AC</h1>
    <a href="<?php echo e(route('teknisi.dashboard')); ?>" class="btn btn-sm btn-secondary shadow-sm"><i class="fas fa-arrow-left fa-sm text-white-50"></i> Kembali</a>
</div>
            ...
            <div class="card-body">
                <table class="table table-borderless table-sm">
                    <tr>
                        ...
                        <td>: <?php echo e($pekerjaan->user->nama_lengkap ?? $pekerjaan->user->name); ?></td>
                    </tr>
                    <tr>
                        <th>No HP</th>
                        <td>: <?php echo e($pekerjaan->user->no_hp ?? '-'); ?></td>
                    </tr>
                    <tr>
                        <th>Alamat</th>
                    ...
                    <tr>
                        <th>Layanan</th>
                        <td>: <span class="badge badge-primary"><?php echo e($pekerjaan->layanan->nama ?? '-'); ?></span></td>
                    </tr>
                    <tr>
                        <th>Merk AC</th>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="p-2 border rounded bg-light">
                                <?php echo e($pekerjaan->detail_keluhan ?: 'Tidak ada detail keluhan yang dicatat.'); ?>
        ...
        <div class="card shadow border-left-primary h-100">
            ...
            <div class="card-body">
                <?php if($pekerjaan->status !== 'selesai'): ?>
                    <form action="<?php echo e(route('teknisi.pekerjaan.selesai', $pekerjaan->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="alert alert-success mt-2">
                        <i class="fas fa-check-circle"></i> Pekerjaan ini telah selesai pada <?php echo e($pekerjaan->updated_at->format('d M Y H:i')); ?>.
                    </div>
                    
                    <?php if($pekerjaan->detailServis->count() > 0): ?>
                        ...
                        <ul class="list-group">
                            <?php $__currentLoopData = $pekerjaan->detailServis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item">
                                    <strong><?php echo e($detail->item); ?></strong> (<?php echo e($detail->quantity); ?> <?php echo e($detail->satuan); ?>)<br>
                                    <small class="text-muted">Catatan: <?php echo e($detail->catatan ?: '-'); ?></small>
                                </li>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('sparepartSelect', () => ({
            produks: <?php echo json_encode($produks, 15, 512) ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/teknisiac/dashboard/show.blade.php ENDPATH**/ ?>