<?php $__env->startSection('title', 'Edit Unit ' . $unit->kode_unit); ?>
        ...
        <div class="col-lg-9">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('adminkantin.unit.update', $unit->id)); ?>"
                          method="POST"
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           value="<?php echo e($unit->kode_unit); ?>"
                                           readonly>
                                </div>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kat->id); ?>"
                                            <?php echo e(old('kategori_id', $unit->kategori_id) == $kat->id ? 'selected' : ''); ?>>
                                            <?php echo e($kat->nama); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           value="<?php echo e(old('harga', $unit->harga)); ?>"
                                ...
                                <div class="d-flex">
                                    <div class="custom-control custom-radio mr-4">
                                        <input type="radio" id="status_kosong" name="status_unit"
                                               ...
                                               <?php echo e(old('status_unit', $unit->status_unit) === 'kosong' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="border rounded p-3 bg-light">
                                        ...
                                        <?php $__currentLoopData = $unit->dokumentasiUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="custom-control custom-checkbox mb-2">
                                                <input type="checkbox"
                                                       class="custom-control-input"
                                                       id="hapus_dok_<?php echo e($dok->id); ?>"
                                                       name="hapus_dokumen[]"
                                                       value="<?php echo e($dok->id); ?>">
                                                <label class="custom-control-label" for="hapus_dok_<?php echo e($dok->id); ?>">
                                                    ...
                                                    <?php endif; ?>
                                                    <span class="text-sm">
                                                        <?php echo e(basename($dok->file)); ?>

                                                    </span>
                                                    <span class="badge badge-light ml-1"><?php echo e($dok->tipe); ?></span>
                            ...
                            <div class="col-sm-9">
                                <div class="custom-file">
                                    <input type="file"
                                           name="dokumen[]"
                                           id="dokumen"
                                           class="custom-file-input <?php $__errorArgs = ['dokumen'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <?php $__errorArgs = ['dokumen.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-sm-9 offset-sm-3">
                                ...
                                <a href="<?php echo e(route('adminkantin.unit.index')); ?>" class="btn btn-light ml-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/adminkantin/unit/edit.blade.php ENDPATH**/ ?>