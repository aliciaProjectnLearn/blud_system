<?php $__env->startSection('title', 'Katalog Sewa Kantin & Ruko'); ?>
    ...
    <div class="hero-kantin animate__animated animate__fadeIn">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('user.kantin.dashboard')); ?>" class="btn btn-light font-weight-bold px-4 py-2 mr-2">
    ...
    <div class="card shadow mb-5">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas <?php echo e($cat['icon']); ?> mr-2"></i><?php echo e($cat['nama']); ?>
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-outline-primary btn-block mb-3 d-md-none btn-zoom-trigger" 
                data-title="<?php echo e($cat['nama']); ?>" data-target="#<?php echo e($cat['svg_id']); ?>">
                <i class="fas fa-map mr-1"></i> Lihat Denah <?php echo e($cat['nama']); ?>

            </button>

            <div class="denah-container d-none d-md-flex">
                <a href="javascript:void(0)" class="btn-zoom-denah btn-zoom-trigger" data-title="<?php echo e($cat['nama']); ?>" data-target="#<?php echo e($cat['svg_id']); ?>">
                    <i class="fas fa-search-plus"></i>
                </a>
                <svg id="<?php echo e($cat['svg_id']); ?>" width="100%"></svg>
            </div>

            
            <div class="row mt-4">
                <?php $__currentLoopData = $rukoList->where('kategori_id', $cat['id']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                    <div class="unit-card shadow-sm">
                        <div class="card-img-container">
                            ...
                            ?>
                            <?php if($path): ?>
                                <img src="<?php echo e(asset('storage/' . str_replace('\\','/',$path))); ?>" class="card-img-top" alt="<?php echo e($ruko->kode_unit); ?>">
                            <?php else: ?>
                                <div class="img-placeholder"><i class="fas <?php echo e($cat['icon']); ?>"></i></div>
                            <?php endif; ?>
                            <span class="badge badge-status <?php echo e($ruko->status_unit == 'kosong' ? 'badge-success' : 'badge-danger'); ?>">
                                <?php echo e($ruko->status_unit == 'kosong' ? 'Tersedia' : 'Terisi'); ?>

                            </span>
                        </div>
                        <div class="card-body">
                            <span class="category-label"><?php echo e($cat['nama']); ?></span>
                            <h5 class="card-title"><?php echo e($ruko->kode_unit); ?></h5>
                            <div class="price-tag">Rp <?php echo e(number_format($ruko->harga, 0, ',', '.')); ?><small>/tahun</small></div>
                            <?php if($ruko->status_unit == 'kosong'): ?>
                                <button type="button" class="btn btn-primary btn-block btn-booking btn-sm" onclick="showUnitDetail(<?php echo e($ruko->id); ?>)">
...
<script>
$(function() {
    const rukoDataArr = <?php echo json_encode($rukoDataJs); ?>;
    const rukoData = rukoDataArr;
    const bookingUrlBase = "<?php echo e(url('user/kantin/booking')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/kantin/katalog.blade.php ENDPATH**/ ?>