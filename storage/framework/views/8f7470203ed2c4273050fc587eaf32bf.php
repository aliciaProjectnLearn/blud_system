...
<div class="welcome-banner animate__animated animate__fadeIn">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h3 class="font-weight-bold">Selamat Datang, <?php echo e($user->name); ?>!</h3>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php if($futsalAktif): ?>
                                #<?php echo e($futsalAktif->booking->id); ?>

                                <span class="badge badge-warning text-xs font-weight-normal"><?php echo e($futsalAktif->booking->status); ?></span>
                            <?php else: ?>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="mt-1 text-sm font-weight-bold">
                            <?php echo e(\Carbon\Carbon::parse($sewaRuko->tgl_selesai)->format('d M Y')); ?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php if($acMendatang): ?>
                                <?php echo e(\Carbon\Carbon::parse($acMendatang->tgl_kunjungan)->format('d M Y')); ?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalTransaksi); ?> Transaksi</div>
                    </div>
                    <div class="col-auto">
...
<div class="row mb-5">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('user.futsal.index')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('user.kantin.katalog')); ?>" class="text-decoration-none">
            <div class="card quick-access-card shadow-sm border-0">
    ...
    <div class="col-md-4 mb-3">
        <a href="<?php echo e(route('user.ac.layanan')); ?>" class="text-decoration-none">
            <div class="card quick-access-card shadow-sm border-0">
...
<div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-hover" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="font-weight-bold"><?php echo e($act['layanan']); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($act['tanggal'])->format('d/m/Y')); ?></td>
                                <td>Rp <?php echo e(number_format($act['nominal'], 0, ',', '.')); ?></td>
                                <td>
                                    <span class="badge badge-<?php echo e($act['badge']); ?>">
                                        <?php echo e($act['status']); ?>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($futsalAktif): ?>
                <h4 class="small font-weight-bold">Futsal: #<?php echo e($futsalAktif->booking->id); ?> <span class="float-right"><?php echo e(ucwords($futsalAktif->booking->status)); ?></span></h4>
                <div class="progress mb-4">
                    ...
                    ?>
                    <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e($perc); ?>%" aria-valuenow="<?php echo e($perc); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <?php endif; ?>

                <?php if($acMendatang): ?>
                <h4 class="small font-weight-bold">Servis AC: <?php echo e(\Carbon\Carbon::parse($acMendatang->tgl_kunjungan)->format('d M')); ?> <span class="float-right"><?php echo e(ucwords($acMendatang->status)); ?></span></h4>
                <div class="progress mb-4">
                    <?php
                        $percAc = 0;
                    ...
                    ?>
                    <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo e($percAc); ?>%" aria-valuenow="<?php echo e($percAc); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <?php endif; ?>

                <?php if($sewaRuko && count($sewaRuko->pembayaran) > 0): ?>
                <?php $pay = $sewaRuko->pembayaran->first(); ?>
                <h4 class="small font-weight-bold">Sewa Unit: <?php echo e($sewaRuko->ruko->no_unit ?? 'Ruko'); ?> <span class="float-right text-danger">Jatuh Tempo</span></h4>
                <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <small class="text-muted mt-2 d-block">Batas bayar: <?php echo e(\Carbon\Carbon::parse($pay->tgl_jatuh_tempo)->format('d/m/Y')); ?></small>
                <?php endif; ?>

                <?php if(!$futsalAktif && !$acMendatang && (!$sewaRuko || count($sewaRuko->pembayaran) == 0)): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/dashboard.blade.php ENDPATH**/ ?>