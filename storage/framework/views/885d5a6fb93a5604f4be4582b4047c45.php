    ...
    <div class="login-page">
        <div class="login-card">
            ...
            <div class="login-header">
                <img src="<?php echo e(asset('img/logo_smk.png')); ?>" alt="Logo BLUD System" class="login-logo">
...
unset($__errorArgs, $__bag); ?>" id="email"
                            name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@email.com" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="login-meta">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="login-forgot">Lupa Password?</a>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if(Route::has('register') || Route::has('password.request')): ?>
                        <div class="login-divider">atau</div>
                        <div class="login-links">
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>">Belum punya akun? Daftar</a>
                            <?php endif; ?>
                            <?php if(Route::has('password.request')): ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/auth/login.blade.php ENDPATH**/ ?>