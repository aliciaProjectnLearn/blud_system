<?php $__env->startSection('title', 'Histori Transaksi AC'); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="align-middle text-dark font-weight-bold"><?php echo e($transaksi->bookingAc->user->name ?? 'N/A'); ?></td>
                            ...
                            <td class="align-middle text-center">
                                <div class="text-success small font-weight-bold">
                                    <i class="fas fa-check-circle mr-1"></i> <?php echo e($transaksi->tgl_bayar ? \Carbon\Carbon::parse($transaksi->tgl_bayar)->translatedFormat('d M Y') : '-'); ?>

                                </div>
                            </td>
                            <td class="pr-4 align-middle text-center">
                                <a href="<?php echo e(route('adminac.transaksi.show', $transaksi->id)); ?>" class="btn btn-outline-info btn-sm shadow-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/adminac/transaksi/history.blade.php ENDPATH**/ ?>