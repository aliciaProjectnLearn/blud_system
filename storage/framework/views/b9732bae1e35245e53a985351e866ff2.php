        ...
        <div class="col-12">
            ...
            <div class="hero-ac">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('user.ac.index')); ?>" class="btn btn-outline-light font-weight-bold">Dashboard Saya</a>
                </div>
            ...
            <div class="stats-bar-ac">
                <div class="stat-item">
                    <span class="stat-num"><?php echo e($layanans->total()); ?></span>
                    <span class="stat-lbl">Layanan</span>
                </div>
                <div class="stat-item">
                    <span class="stat-num"><?php echo e($kategoris->count()); ?></span>
                        ...
                        <div class="card service-card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <h6 class="font-weight-bold mb-0 text-dark"><?php echo e($layanan->nama ?? $layanan->nama_layanan); ?></h6>
                                    <span class="price-badge">Rp<?php echo e(number_format($layanan->harga_jasa ?? 0,0,',','.')); ?></span>
                                </div>
                                <p class="service-desc"><?php echo e($layanan->deskripsi ?? 'Pembersihan dan pengecekan komponen AC secara menyeluruh.'); ?></p>
                                <div class="small text-muted mb-4">
                                    <i class="fas fa-tag mr-1"></i> <?php echo e($layanan->kategori->nama ?? '-'); ?> | <i class="fas fa-bolt mr-1"></i> <?php echo e($layanan->kapasitas_ac ?? '-'); ?>

                                </div>
                                <div class="mt-auto d-flex justify-content-between align-items-center">
                                    <button class="btn btn-primary btn-sm btn-book px-4" data-id="<?php echo e($layanan->id); ?>" data-name="<?php echo e($layanan->nama ?? $layanan->nama_layanan); ?>">Booking</button>
...
<script>
    $(document).ready(function(){
        ...
        $('#bookingForm').on('submit', function(e){
            ...
            $.post('<?php echo e(route("user.ac.store")); ?>', $(this).serialize())
                .done(function(res){
...
<?php echo $__env->make('layouts.publik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/ac/layanan.blade.php ENDPATH**/ ?>