<?php $__env->startSection('title', 'Histori Booking Layanan AC'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 mb-1">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('user.ac.index')); ?>">Dashboard</a></li>
        ...
        <div class="d-flex align-items-center">
            <a href="<?php echo e(route('user.ac.history')); ?>" class="btn btn-sm btn-light border shadow-sm mr-2 text-primary">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover text-center" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e(($history->currentPage()-1) * $history->perPage() + $loop->iteration); ?></td>
                            <td><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('d M Y')); ?></td>
                            <td class="text-left">
                                <span class="font-weight-bold text-primary"><?php echo e($item->layanan->nama ?? 'N/A'); ?></span><br>
                                <small class="text-muted"><?php echo e($item->merek_ac); ?></small>
                            </td>
                            <td><?php echo e($item->teknisi->name ?? 'Belum Ditentukan'); ?></td>
                            <td class="font-weight-bold">
                                Rp <?php echo e(number_format($item->pembayaran->total_harga ?? 0, 0, ',', '.')); ?>
                            ...
                            <td>
                                <button onclick="viewDetail(<?php echo e($item->id); ?>)" class="btn btn-info btn-sm shadow-sm rounded-pill px-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/user/ac/history.blade.php ENDPATH**/ ?>