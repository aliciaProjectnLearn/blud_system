<?php $__env->startSection('title', 'Laporan Transaksi AC'); ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('adminac.laporan.index')); ?>">
                <div class="form-row align-items-end">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <a href="<?php echo e(route('adminac.laporan.index')); ?>" class="btn btn-secondary">
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-6 col-md-6 d-flex justify-content-end align-items-center">
            <a href="<?php echo e(route('adminac.laporan.export.pdf', request()->all())); ?>" target="_blank" class="btn btn-danger mr-2 shadow-sm">
                <i class="fas fa-file-pdf fa-sm text-white-50"></i> Export PDF
            </a>
            <a href="<?php echo e(route('adminac.laporan.export.excel', request()->all())); ?>" target="_blank" class="btn btn-success shadow-sm">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $laporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="align-middle"><?php echo e($item->invoice_no ?? '-'); ?></td>
                                <td class="align-middle"><?php echo e($item->bookingAc->user->name ?? '-'); ?></td>
                                <td class="align-middle"><?php echo e($item->bookingAc->layanan->nama_layanan ?? ($item->bookingAc->layanan->nama ?? '-')); ?></td>
                                <td class="align-middle"><?php echo e($item->bookingAc->teknisi->name ?? '-'); ?></td>
                                <td class="align-middle"><?php echo e($item->bookingAc->tgl_kunjungan ?? '-'); ?></td>
                                ...
                                <td class="align-middle text-center">
                                    <?php if(strtolower($item->status) == 'lunas'): ?>
                                        <span class="badge badge-success px-2 py-1"><?php echo e($item->status); ?></span>
                                    <?php elseif(strtolower($item->status) == 'menunggu' || strtolower($item->status) == 'pending' || strtolower($item->status) == 'belum lunas'): ?>
                                        <span class="badge badge-warning px-2 py-1"><?php echo e($item->status); ?></span>
                                    <?php elseif(strtolower($item->status) == 'dibatalkan' || strtolower($item->status) == 'batal'): ?>
                                        <span class="badge badge-danger px-2 py-1"><?php echo e($item->status); ?></span>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blud_system\resources\views/adminac/laporan/index.blade.php ENDPATH**/ ?>