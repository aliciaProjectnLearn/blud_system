...
<head>
    ...
    <title>BLUD Portal - <?php echo $__env->yieldContent('title', 'Layanan'); ?></title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light navbar-pelanggan mb-4 sticky-top">
                    <div class="container py-2">
                        <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('user.gateway')); ?>">
                            <div class="logo-box">
                        ...
                        <?php if(!isset($hideNavbarBack) || !$hideNavbarBack): ?>
                        <a href="<?php echo e(route('user.gateway')); ?>" class="btn btn-sm btn-light btn-kembali text-primary shadow-sm px-3">
...
<?php /**PATH C:\laragon\www\blud_system\resources\views/layouts/publik.blade.php ENDPATH**/ ?>