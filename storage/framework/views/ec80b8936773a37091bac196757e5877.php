...
<body class="min-h-screen">
    ...
    <section id="home" class="relative py-24 overflow-hidden" style="background-color:#EEEEEE;">
        <div class="absolute inset-0 opacity-10">
            <img src="<?php echo e(asset('img/depan_smk (1).JPG')); ?>" alt="SMK" class="w-full h-full object-cover"/>
        </div>
    ...
    <section id="layanan" class="py-24 bg-[#f8f9fc]">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid-layanan">
                ...
                <a href="<?php echo e(route('user.futsal.landing')); ?>" class="card-hover block bg-white p-6 rounded-2xl shadow-sm border-t-4 border-[#4e73df] text-center flex flex-col h-full no-underline">
                ...
                <a href="<?php echo e(route('user.kantin.katalog')); ?>" class="card-hover block bg-white p-6 rounded-2xl shadow-sm border-t-4 border-[#4e73df] text-center flex flex-col h-full no-underline">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm" style="background-color:#4e73df;">
                        <svg class="text-white" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?php echo e(route('user.ac.layanan')); ?>" class="card-hover block bg-white p-6 rounded-2xl shadow-sm border-t-4 border-[#4e73df] text-center flex flex-col h-full no-underline">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm" style="background-color:#4e73df;">
                        <svg class="text-white" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?php echo e(route('user.servis.katalog')); ?>" class="card-hover block bg-white p-6 rounded-2xl shadow-sm border-t-4 border-[#4e73df] text-center flex flex-col h-full no-underline">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm" style="background-color:#4e73df;">
                        <svg class="text-white" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm border-l-4 border-[#4e73df] text-center flex flex-col h-full hover:shadow-md transition-shadow">
                    <div class="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm" style="background-color:#4e73df;">
                        <svg class="text-white" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="<?php echo e($item['path']); ?>"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold mb-3" style="color:#4e73df;"><?php echo e($item['title']); ?></h3>
                    <p class="text-gray-600 leading-relaxed flex-grow text-sm"><?php echo e($item['desc']); ?></p>
                </div>
            ...
            <div class="border-t border-gray-300 pt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <?php $__currentLoopData = [['500+','Masyarakat Terdaftar'],['1.500+','Transaksi Booking Berhasil'],['200+','Unit Ruko & Kantin Aktif']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-10 rounded-2xl shadow-sm border-l-4 border-[#4e73df] hover:shadow-md hover:-translate-y-1 transition-all text-center">
                        <div class="text-5xl font-black mb-4" style="color:#4e73df;"><?php echo e($s[0]); ?></div>
                        <p class="font-bold" style="color:#4e73df;"><?php echo e($s[1]); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-[#4e73df] hover:shadow-md transition-shadow">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <div class="font-bold text-gray-800 text-sm"><?php echo e($t->nama); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($t->peran); ?></div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <?php for($i = 0; $i < $t->bintang; $i++): ?><span class="star text-sm">★</span><?php endfor; ?>
                        <?php for($i = $t->bintang; $i < 5; $i++): ?><span class="text-gray-300 text-sm">★</span><?php endfor; ?>
                    </div>
                    <p class="text-gray-600 text-sm leading-relaxed">"<?php echo e($t->isi); ?>"</p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <footer id="kontak" class="py-16" style="background-color:#4e73df;">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <?php $__currentLoopData = ['Kebijakan Privasi','Syarat & Ketentuan','Bantuan','FAQ']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors"><?php echo e($link); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="#" class="w-10 h-10 rounded-lg flex items-center justify-center bg-white/20 hover:bg-white/30 transition-colors">
                            <svg class="text-white w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="<?php echo e($svg); ?>"/></svg>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="border-t border-blue-400 pt-8 text-center">
                <p class="text-gray-300 text-sm">© <?php echo e(date('Y')); ?> BLUD SMKN 1 Cirebon. Semua hak dilindungi undang-undang.</p>
            </div>
        </div>
    </footer>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="text-sm text-gray-400">
                    &copy; <?php echo e(date('Y')); ?> BLUD SMKN 1 CIREBON. All rights reserved.
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                text: 'Link akses servis kamu sudah dikirim ke WhatsApp <?php echo e(session('no_hp')); ?>. Simpan link tersebut untuk memantau status servis kamu.',
...
<?php /**PATH C:\laragon\www\blud_system\resources\views/user/gateway.blade.php ENDPATH**/ ?>